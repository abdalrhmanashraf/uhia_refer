...
// ─── بيانات وهمية للطلبات (مربوطة بالمستشفيات الـ 5) ────────────────────────
const now = new Date();
...
export const mockReferrals: Referral[] = [
  {
    id: 'REF-2608-001',
    nationalId: '27901012700111',
    patientName: 'محمود السيد عبد الله',
    patientAge: 47,
    gender: 'male',
    phone: '01012345678',
    sourceUnitId: 'unit_aqr_01',
    targetHospitalId: 'HOSP_CLEO',
    referringDoctor: 'د. عمرو سليمان',
    specialty: 'جراحة عظام',
    urgency: 'urgent',
    clinicalSummary: 'خشونة متقدمة بمفصل الركبة اليمنى تستدعي تدخلاً جراحياً لاستبدال المفصل',
  ...
  {
    id: 'REF-2608-002',
    nationalId: '29005052701234',
    patientName: 'فاطمة حسن علي',
    patientAge: 36,
    gender: 'female',
    phone: '01198765432',
    sourceUnitId: 'unit_aqr_03',
    targetHospitalId: 'HOSP_NADA',
    referringDoctor: 'د. نهى أحمد سعيد',
    specialty: 'أمراض نسا وتوليد',
    urgency: 'emergency',
    clinicalSummary: 'حمل حرج عالي الخطورة مع تسمم حمل وانفصال جزئي بالمشيمة — يستلزم عناية عاجلة',
    status: 'PENDING_REVIEW',
    createdAt: d(0.5),
    createdBy: 'u_s1',
    lastModifiedAt: d(0.5),
  },
  {
    id: 'REF-2608-003',
    nationalId: '30201072701555',
    patientName: 'ياسين أحمد محمود',
    patientAge: 24,
    gender: 'male',
    phone: '01555123456',
    sourceUnitId: 'unit_armt_01',
    targetHospitalId: 'HOSP_ROAA',
    referringDoctor: 'د. خالد رمضان',
    specialty: 'أمراض العيون (رمد)',
    urgency: 'routine',
    clinicalSummary: 'عتامة شديدة بالقرنية مع ماء أبيض يستلزم عملية إزالة وتثبيت عدسة',
    status: 'ACCEPTED',
    createdAt: d(5),
    createdBy: 'u_s3',
    lastModifiedAt: d(3),
  ...
  {
    id: 'REF-2608-004',
    nationalId: '27803042702222',
    patientName: 'سميرة محمد عبد الرحمن',
    patientAge: 48,
    gender: 'female',
    phone: '01023456789',
    sourceUnitId: 'unit_isn_01',
    targetHospitalId: 'HOSP_EYE_INT',
    referringDoctor: 'د. أمل حسام الدين',
    specialty: 'جراحة عيون وقرنية',
    urgency: 'urgent',
    clinicalSummary: 'انفصال شبكي حاد بالعين اليسرى يستلزم جراحة دقيقة وعاجلة',
    status: 'PENDING_HOSPITAL',
    createdAt: d(3),
    createdBy: 'u_s4',
    lastModifiedAt: d(2),
  ...
  {
    id: 'REF-2608-005',
    nationalId: '28804122703333',
    patientName: 'حسام إبراهيم الديب',
    patientAge: 38,
    gender: 'male',
    phone: '01234567890',
    sourceUnitId: 'unit_aqr_01',
    targetHospitalId: 'HOSP_KAMAL',
    referringDoctor: 'د. عمرو سليمان',
    specialty: 'جراحة عامة',
    urgency: 'routine',
    clinicalSummary: 'فتق إربي مزدوج متكرر يستلزم ترقيع شبكي جراحي',
    status: 'DRAFT',
    createdAt: d(0.1),
    createdBy: 'u_s2',
    lastModifiedAt: d(0.1),
  },
  {
    id: 'REF-2608-006',
    nationalId: '28509092700106',
    patientName: 'نادية سعيد عوض',
    patientAge: 41,
    gender: 'female',
    phone: '01012312312',
    sourceUnitId: 'unit_isn_01',
    targetHospitalId: 'HOSP_CLEO',
    referringDoctor: 'د. منى صالح خليل',
    specialty: 'أورام وأشعة علاجية',
    urgency: 'urgent',
    clinicalSummary: 'ورم ليفي كبير متكلس يستلزم فحص رنين واستئصال جذري',
    status: 'HOSPITAL_RFI',
    createdAt: d(4),
    createdBy: 'u_s4',
    lastModifiedAt: d(1),
