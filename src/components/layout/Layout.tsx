...
const pageTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  '/accepted': { title: 'التحويلات المقبولة', subtitle: 'سجل الحالات التي وافقت المستشفيات على استقبالها' },
  '/rejected': { title: 'التحويلات المرفوضة', subtitle: 'متابعة أسباب اعتذار المستشفيات وإعادة التوجيه' },
  '/overview': { title: 'شرح ودليل ورؤية المنظومة', subtitle: 'الرؤية الاستراتيجية وسد الفجوة الرقمية مع هيئة الرعاية الصحية' },
