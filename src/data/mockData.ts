...
export const mockUsers: User[] = [
  ...
  // ─── أخصائيو المنافذ (بيانات حقيقية من البيان) ─────────────────────────
  {
    id: 'u_s1',
  ...
  {
    id: 'u_s5',
    name: 'ممدوح علي قناوي',
    email: 'm.qanawi@uhia-luxor.gov.eg',
    username: 'm.qanawi',
    role: 'UNIT_SPECIALIST',
    unitId: 'unit_armt_02',
    jobTitle: 'أخصائي منفذ — ارمنت الرئيسي',
    isActive: true,
    createdAt: '2024-02-01T00:00:00Z',
  },
  {
    id: 'u_s6',
    name: 'سميه حمدي محمد عبدالعال',
    email: 's.hamdي@uhia-luxor.gov.eg',
    username: 's.hamdi',
    role: 'UNIT_SPECIALIST',
    unitId: 'unit_aqr_12',
    jobTitle: 'أخصائي منفذ — وحدة طب أسرة نجع الخطباء',
    isActive: true,
    createdAt: '2024-02-01T00:00:00Z',
  },
  ...
  {
    id: 'u_h1',
    name: 'سوسن محمود أحمد عبدالحكيم',
    email: 'reception@isis-luxor.eg',
    username: 'hosp.isis',
    role: 'HOSPITAL_RECEIVER',
    hospitalId: 'CARE006',
    jobTitle: 'مسؤول قبول التحويلات — مستشفى إيزيس التخصصي',
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
  },
  {
    id: 'u_h2',
    name: 'صفاء عبد العظيم النوبي',
    email: 'reception@horus-luxor.eg',
    username: 'hosp.horus',
    role: 'HOSPITAL_RECEIVER',
    hospitalId: 'CARE002',
    jobTitle: 'مسؤول قبول التحويلات — مستشفى حورس التخصصي',
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
  },
  {
    id: 'u_h3',
    name: 'شمس الدين عبد الكريم جلال',
    email: 'reception@thebes-luxor.eg',
    username: 'hosp.thebes',
    role: 'HOSPITAL_RECEIVER',
    hospitalId: 'CARE007',
    jobTitle: 'مسؤول قبول التحويلات — مستشفى طيبة التخصصي',
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
  },
];
...
// ─── المستشفيات المتعاقدة الحقيقية — هيئة التأمين الصحي الشامل فرع الأقصر ───
// المصدر: نظام UHIA-LuxorSystem — ملفات Surveys_V3 + بيان المنافذ
export const mockHospitals: Hospital[] = [
  {
    ...
    address: 'الأقصر',
    location: 'الأقصر',
    specialties: ['باطنة وجهاز هضمي', 'جراحة عامة', 'جراحة عظام', 'أمراض القلب والأوعية', 'أشعة تشخيصية', 'نسا وتوليد'],
  },
  {
    id: 'CARE002',
    ...
    location: 'أرمنت',
    specialties: ['باطنة وجهاز هضمي', 'جراحة عامة', 'أمراض الأطفال', 'أمراض القلب', 'أمراض الجلد'],
  },
  {
    id: 'CARE003',
    name: 'مستشفى العديسات التخصصي',
    type: 'private',
    address: 'العديسات — أرمنت شرق، الأقصر',
    location: 'أرمنت - شرق',
    specialties: ['جراحة عامة', 'باطنة', 'أمراض الأطفال', 'نسا وتوليد'],
  },
  {
    id: 'CARE004',
    ...
    location: 'الأقصر',
    specialties: ['جراحة عامة', 'جراحة عظام', 'باطنة وجهاز هضمي', 'أمراض العيون', 'أمراض الأطفال'],
  },
  {
    id: 'CARE005',
    name: 'مستشفى الأقصر الدولي (فرع ثانٍ)',
    type: 'private',
    address: 'شارع التلفزيون، الأقصر',
    location: 'الأقصر',
    specialties: ['أورام وأشعة علاجية', 'جراحة عامة', 'جراحة عظام', 'باطنة'],
  },
  {
    id: 'CARE006',
    ...
    address: 'الأقصر',
    location: 'الأقصر',
    specialties: ['نسا وتوليد', 'أطفال حديثي الولادة', 'أمراض الأطفال', 'جراحة نسائية'],
  },
  {
    id: 'CARE007',
    ...
    address: 'إسنا، الأقصر',
    location: 'إسنا',
    specialties: ['باطنة وجهاز هضمي', 'جراحة عامة', 'أمراض الكلى', 'أمراض الصدر والجهاز التنفسي'],
  },
  {
    id: 'CARE008',
    ...
    address: 'الأقصر',
    location: 'الأقصر',
    specialties: ['أورام وأشعة علاجية', 'جراحة أورام', 'كيماوي وعلاج إشعاعي'],
  },
];
